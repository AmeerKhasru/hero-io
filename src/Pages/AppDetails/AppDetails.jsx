...
const AppDetails = () => {
    ...
    useEffect(() => {
        if (app) {
            ...
            const alreadyInstalled = storedApps.some(item => item.id === app.id);
                    ...
                    <div className="h-[300px] w-full">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart layout="vertical" data={ratingData} margin={{ top: 5, right: 30, left: 40, bottom: 5 }}>
                                <XAxis type="number" axisLine={false} tickLine={false} tick={{ fill: '#CBD5E1', fontSize: 12, fontWeight: 'bold' }} />
